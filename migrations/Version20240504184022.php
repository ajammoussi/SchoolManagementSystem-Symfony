 ...
 */
final class Version20240504184022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE schedule (schedule_id INT NOT NULL, instructor_id INT NOT NULL, course_id INT NOT NULL, start_date DATE NOT NULL, start_time TIME NOT NULL, end_time TIME NOT NULL, room VARCHAR(255) DEFAULT NULL, description VARCHAR(255) NOT NULL, expiry_date DATETIME NOT NULL, field VARCHAR(255) NOT NULL, studylevel INT NOT NULL, INDEX IDX_5A3811FB8C4FC193 (instructor_id), PRIMARY KEY(schedule_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
