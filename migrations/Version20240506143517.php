...
final class Version20240506143517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pdf_file (filename VARCHAR(255) NOT NULL, content LONGBLOB NOT NULL, PRIMARY KEY(filename)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
